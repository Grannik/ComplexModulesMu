...
#define TAG_JA L"<ja>"        // Цвет текста: черный на черном фоне
#define TAG_JB L"<jb>"        // Цвет текста: красный на черном фоне
#define TAG_JC L"<jc>"        // Цвет текста: зеленый на черном фоне
#define TAG_JD L"<jd>"        // Цвет текста: желтый на черном фоне
#define TAG_JE L"<je>"        // Цвет текста: синий на черном фоне
#define TAG_JF L"<jf>"        // Цвет текста: пурпурный на черном фоне
#define TAG_JG L"<jg>"        // Цвет текста: голубой на черном фоне
#define TAG_JH L"<jh>"        // Цвет текста: белый на черном фоне
#define TAG_JI L"<ji>"        // Цвет текста: серый на черном фоне
...
// Структура для соответствия тега и атрибута ncurses
struct TagMapping {
    const wchar_t *tag;
    attr_t attribute;
...
extern const struct TagMapping tag_mappings[];
